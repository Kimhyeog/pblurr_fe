  ...
  switch (category) {
    ...
    case "색소침착":
      return {
        ...
        bg: "#f6f0fd",
        border: "#d7c4f3",
        badgeStyle: "bg-white text-[#7a55ba] border border-[#c8b3e6]",
    ...
    case "모공":
      return {
        ...
        bg: "#fff8e7",
        border: "#fcd6a3",
        badgeStyle: "bg-white text-[#b67a10] border border-[#f5c879]",
    ...
    default:
      return {
        ...
        bg: "#f0f3ff",
        border: "#c8d2ff",
        badgeStyle: "bg-white text-[#444b8f] border border-[#b5c1f7]",
      ...
      {cosmetics?.map((recommendation, index) => {
        ...
        return (
          ...
          >
            {/* 카테고리 카드 */}
            <div
              className="w-full max-w-xs mx-auto shadow rounded-xl py-4 px-6 mb-6 flex flex-col items-center"
              style={{
            ...
            >
              <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <h2
                  className={`text-md sm:text-lg font-semibold ${theme.textStyle}`}
                >
                  {recommendation.category} 추천 제품
                </h2>
              </div>
              <span
                className={`text-sm font-bold px-3 py-1 rounded-full ${theme.badgeStyle}`}
              >
